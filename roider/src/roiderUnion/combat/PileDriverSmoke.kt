 ...
 * @author Nicke535
 */
class PileDriverSmoke : EveryFrameWeaponEffectPlugin {
    companion object {
        private const val DEFAULT = "default"
        private const val SMOKE1 = "SMOKE1"
        private const val SMOKE2 = "SMOKE2"
        private const val SMOKE3 = "SMOKE3"
        private const val SMOKE4 = "SMOKE4"
        ...
        val PROHIBITED_REAR: MutableMap<String, List<*>> = HashMap()

        init {
            PROHIBITED_REAR["loamt_alastair"] = listOf("WS0001", "WS0002")
            PROHIBITED_REAR["loamt_macnamara"] = listOf("WS0005", "WS0006")
            PROHIBITED_REAR["roider_firestorm"] = listOf("WS 000")
            PROHIBITED_REAR["roider_gambit"] = listOf("WS 005")
            PROHIBITED_REAR["roider_gambit_early"] = listOf("WS 005")
            PROHIBITED_REAR["roider_gambit_p"] = listOf("WS 005")
            PROHIBITED_REAR["roider_gambit_p_early"] = listOf("WS 005")
            PROHIBITED_REAR["roider_wrecker"] = listOf("WS 006", "WS 007")
            PROHIBITED_REAR["vic_apollyon"] = listOf("WS0018")
            PROHIBITED_REAR["vic_moloch"] = listOf("WS0007")
            PROHIBITED_REAR["vic_valafar"] = listOf("WS0005")
            PROHIBITED_REAR["vic_kobal"] = listOf("WS0005", "WS0006")
            PROHIBITED_REAR["vic_thamuz"] = listOf("WS0005", "WS0013")
            PROHIBITED_REAR["vic_jezebeth"] = listOf("WS0006")
        }
        ...
        */
        ...
        init {
            ON_SHOT_PARTICLE_COUNT[DEFAULT] = 2
            ON_SHOT_PARTICLE_COUNT[SMOKE1] = 20
            ON_SHOT_PARTICLE_COUNT[SMOKE2] = 20
            ON_SHOT_PARTICLE_COUNT[SMOKE3] = 20
            ON_SHOT_PARTICLE_COUNT[SMOKE4] = 20
            ON_SHOT_PARTICLE_COUNT[EXHAUST_PUFF] = 10
        }
        ...
        init {
            PARTICLE_SPAWN_POINT_TURRET[DEFAULT] =
                Vector2f(22f, 0f)
            PARTICLE_SPAWN_POINT_TURRET[SMOKE1] =
                Vector2f(10f, 22f)
            PARTICLE_SPAWN_POINT_TURRET[SMOKE2] = Vector2f(16f, 20f)
            PARTICLE_SPAWN_POINT_TURRET[SMOKE3] = Vector2f(-10f, 22f)
            PARTICLE_SPAWN_POINT_TURRET[SMOKE4] =
                Vector2f(-16f, 20f)
            PARTICLE_SPAWN_POINT_TURRET[EXHAUST_PUFF] =
                Vector2f(0f, -20f)
            PARTICLE_SPAWN_POINT_TURRET[EXHAUST] = Vector2f(0f, -20f)
        }
        ...
        init {
            ...
            PARTICLE_SPAWN_POINT_HARDPOINT[SMOKE1] =
                Vector2f(10f, 13f)
            PARTICLE_SPAWN_POINT_HARDPOINT[SMOKE2] = Vector2f(16f, 12f)
            PARTICLE_SPAWN_POINT_HARDPOINT[SMOKE3] =
                Vector2f(-10f, 13f)
            PARTICLE_SPAWN_POINT_HARDPOINT[SMOKE4] = Vector2f(-16f, 12f)
            PARTICLE_SPAWN_POINT_HARDPOINT[EXHAUST_PUFF] =
                Vector2f(0f, -25f)
            PARTICLE_SPAWN_POINT_HARDPOINT[EXHAUST] = Vector2f(0f, -25f)
        }
        ...
        init {
            ...
            PARTICLE_SIZE_MAX[SMOKE2] = 15f
            PARTICLE_SIZE_MAX[SMOKE4] = 15f
        ...
        init {
            PARTICLE_OFFSET_MAX[DEFAULT] = 25f
        ...
        init {
            PARTICLE_ARC[DEFAULT] = 15f
            PARTICLE_ARC[EXHAUST_PUFF] = 10f
        ...
        init {
            ...
            PARTICLE_ARC_FACING[SMOKE1] = 3f
            PARTICLE_ARC_FACING[SMOKE2] = 6f
            PARTICLE_ARC_FACING[SMOKE3] = -3f
            PARTICLE_ARC_FACING[SMOKE4] = -6f
    ...
    override fun advance(amount: Float, engine: CombatEngineAPI?, weapon: WeaponAPI?) {
        ...
        var noRearEffects = (PROHIBITED_REAR.containsKey(hullId)
                && PROHIBITED_REAR[hullId]!!.contains(weaponSlotId))
