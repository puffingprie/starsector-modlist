...
public class fed_ShotgunSpecialBehaviorSmall implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        for (int j = 0; j < shotCount; j++) {
            ...
            float angleVariance = MathUtils.getRandomNumberInRange(-2f, 2f);
            randomVel.x -= vel.x;
            randomVel.y -= vel.y;
