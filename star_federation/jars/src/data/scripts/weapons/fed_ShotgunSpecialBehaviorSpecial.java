...
public class fed_ShotgunSpecialBehaviorSpecial implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
                ...
                for (int j = 0; j < shotCount; j++) {
                    ...
                    float angleVariance = MathUtils.getRandomNumberInRange(-7f, 7f);
                    randomVel.x -= vel.x;
                    randomVel.y -= vel.y;
