...
// Handles stations for random battles
public class FEDMissionStationDefs
{
    ...
    static
    {
        ...
        AvailableStationSet federationSet = new AvailableStationSet(
                new Pair<>(new AvailableStation("fed_station_1_standard", 100, 100), 1f),
                new Pair<>(new AvailableStation("fed_station_2_standard", 200, 200), 1f),
                new Pair<>(new AvailableStation("fed_station_3_standard", 350, 350), 1f)
        );
        ...
        AvailableStationSet diableSet = new AvailableStationSet(
                new Pair<>(new AvailableStation("diableavionics_station_tier1", 100, 100), 1f), // Is like a tier 1 station
                new Pair<>(new AvailableStation("diableavionics_station_tier2", 200, 200), 1f), // Is like a tier 2- station
                new Pair<>(new AvailableStation("diableavionics_station_tier3", 350, 350), 1f) // Is like a tier 3- station
        );
        AvailableStationSet imperiumSet = new AvailableStationSet(
                new Pair<>(new AvailableStation("ii_station1_sta", 100, 100), 1f), // Is like a tier 1 station
                new Pair<>(new AvailableStation("ii_station2_sta", 200, 200), 1f), // Is like a tier 2- station
                new Pair<>(new AvailableStation("ii_station3_sta", 300, 300), 1f), // Is like a tier 2- station
                 new Pair<>(new AvailableStation("ii_station4_sta", 600, 600), 1f) // Is like a tier 4- station
        );
        AvailableStationSet arsSet = new AvailableStationSet(
                new Pair<>(new AvailableStation("loa_arsstation_core_1_variant", 100, 100), 1f), // Is like a tier 1 station
                new Pair<>(new AvailableStation("loa_arsstation_core_2_variant", 200, 200), 1f), // Is like a tier 2- station
                new Pair<>(new AvailableStation("loa_arsstation_core_3_variant", 400, 400), 1f), // Is like a tier 2- station
                 new Pair<>(new AvailableStation("loa_arscapitol_core_variant", 600, 600), 1f) // Is like a tier 4- station
        );
        ...
        stationsByFaction.put("tiandong", allVanillaSet);
        ...
        stationsByFaction.put("diableavionics", diableSet);
        stationsByFaction.put("exigency", null);                          // Doesn't use stations... Yet
        stationsByFaction.put("exipirated", midSet);
        stationsByFaction.put("interstellarimperium", imperiumSet);
        ...
        stationsByFaction.put("al_ars", arsSet);
        ...
        stationsByFaction.put("star_federation", federationSet);
    }
