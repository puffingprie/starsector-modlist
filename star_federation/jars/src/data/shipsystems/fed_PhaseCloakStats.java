...
public class fed_PhaseCloakStats extends BaseShipSystemScript {

    public static final Color JITTER_COLOR = new Color(155, 175, 255, 205);

    public static float JITTER_FADE_TIME = 0.5f;

    public static float SHIP_ALPHA_MULT = 0.2f;
