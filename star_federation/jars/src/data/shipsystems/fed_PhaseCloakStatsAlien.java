...
public class fed_PhaseCloakStatsAlien extends BaseShipSystemScript {

    public static final Color JITTER_COLOR = new Color(155, 175, 255, 185);

    public static float JITTER_FADE_TIME = 0.5f;

    public static float SHIP_ALPHA_MULT = 0.1f;
...
//	public static float MASS_DAMAGE_MULT = 1f;
    ...
    public static float MIN_SPEED_MULT = 0.75f;
    public static float BASE_FLUX_LEVEL_FOR_MIN_SPEED = 0.66f;
