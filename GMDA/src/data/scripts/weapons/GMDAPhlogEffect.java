 ...
 */
public class GMDAPhlogEffect implements OnFireEffectPlugin, OnHitEffectPlugin, EveryFrameWeaponEffectPlugin {

	protected CombatEntityAPI chargeGlowEntity;
	protected GMDAPhlogChargeGlow chargeGlowPlugin;
	public GMDAPhlogEffect() {
	}
	...
	public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
		...
		if (charging && chargeGlowEntity == null) {
			chargeGlowPlugin = new GMDAPhlogChargeGlow(weapon);
	...
	public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
		if (chargeGlowPlugin != null) {
			...
			missile.setMineExplosionRange(GMDAPhlogChargeGlow.MAX_ARC_RANGE + 50f);
