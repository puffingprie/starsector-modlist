 ...
 */
public class GMDAPhlogChargeGlow extends CombatEntityPluginWithParticles {
...
//	}
	...
	public static int MAX_ARC_RANGE = 30;
	//public static int ARCS_ON_HIT = 15;
	
	public static Color UNDERCOLOR = new Color(180, 21, 0, 100);;
	public static Color RIFT_COLOR = new Color(246, 129, 67,255);
	...
	public GMDAPhlogChargeGlow(WeaponAPI weapon) {
		super();
		this.weapon = weapon;
...
//		}
	...
	public void spawnArc() {
		...
		float thickness = 15f;
		float coreWidthMult = 0.8f;
		Color color = new Color(246, 129, 67,135);
...
//			spawnEMPParticles(EMPArcHitType.DEST_NO_TARGET, to, null);
	...
	public Vector2f pickNoTargetDest(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
		float timeboost = (projectile.getElapsed() * 50f);
		float range = MAX_ARC_RANGE + timeboost;;
