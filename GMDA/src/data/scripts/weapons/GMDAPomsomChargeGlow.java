 ...
 */
public class GMDAPomsomChargeGlow extends CombatEntityPluginWithParticles {
	...
	public static int MAX_ARC_RANGE = 100;
	...
	public GMDAPomsomChargeGlow(WeaponAPI weapon) {
		super();
		this.weapon = weapon;
...
//		}
	...
	public void spawnArc() {
		...
		Color color = new Color(246, 129, 67,100);
