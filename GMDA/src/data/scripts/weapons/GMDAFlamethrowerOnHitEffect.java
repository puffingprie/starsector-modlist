...
public class GMDAFlamethrowerOnHitEffect extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public GMDAFlamethrowerOnHitEffect() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		GMDAFlamethrowerOnHitEffect effect = new GMDAFlamethrowerOnHitEffect(projectile, (ShipAPI) target, offset);
	...
	public GMDAFlamethrowerOnHitEffect(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
	...
	public void render(CombatEngineLayers layer, ViewportAPI viewport) {
		...
		Color red = new Color(246, 173, 48,100);
