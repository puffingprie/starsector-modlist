...
import data.scripts.weapons.GMDAPomsomChargeGlow;
 ...
 */
public class GMDAPomsomEffect implements OnFireEffectPlugin, OnHitEffectPlugin, EveryFrameWeaponEffectPlugin {

	protected CombatEntityAPI chargeGlowEntity;
	protected GMDAPomsomChargeGlow chargeGlowPlugin;
	public GMDAPomsomEffect() {
	}
	...
	public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
		...
		if (charging && chargeGlowEntity == null) {
			chargeGlowPlugin = new GMDAPomsomChargeGlow(weapon);
	...
	public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
		if (chargeGlowPlugin != null) {
			...
			missile.setMineExplosionRange(GMDAPomsomChargeGlow.MAX_ARC_RANGE + 50f);
