...
public class GMDAFlaregunOnHitEffect extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public GMDAFlaregunOnHitEffect() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		GMDAFlaregunOnHitEffect effect = new GMDAFlaregunOnHitEffect(projectile, (ShipAPI) target, offset);
	...
	public GMDAFlaregunOnHitEffect(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
