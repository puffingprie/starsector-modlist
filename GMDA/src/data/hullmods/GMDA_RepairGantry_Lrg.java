...
public class GMDA_RepairGantry_Lrg implements HullModEffect, HullModFleetEffect {
    ...
    public void onFleetSync(CampaignFleetAPI fleet) {
        ...
        for (FleetMemberAPI rig : rigs) {
            for (int i = index; i < members.size(); i++) {
                ...
                member.getStats().getRepairRatePercentPerDay().modifyPercent(STAT_MOD_ID, REPAIR_RATE_BONUS_LRG);
                index = i + 1;
                break;
            }
        }
