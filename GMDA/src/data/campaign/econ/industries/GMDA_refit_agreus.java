...
public class GMDA_refit_agreus extends BaseIndustry implements RouteManager.RouteFleetSpawner, FleetEventListener {
		...
		public void apply() {
			...
			demand(Commodities.RARE_METALS, size -4);
	...
	public CampaignFleetAPI spawnFleet(RouteData route) {
		...
		params.flagshipVariantId = "onslaught_GM_attack";
		...
		fleet.getFlagship().setId("onslaught_GM_attack");
