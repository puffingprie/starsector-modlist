...
public class GMDA_refit_ilm extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
	...
	public CampaignFleetAPI spawnFleet(RouteData route) {
		...
		params.flagshipVariantId = "onslaught_GM_cs";
		...
		fleet.getFlagship().setId("onslaught_GM_cs");
