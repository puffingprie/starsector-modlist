package data.missions.xlu_test_other;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Lanestate Union Junkyard");
		...
		api.addToFleet(FleetSide.PLAYER, "xlu_starcrusher_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "xlu_starliner_Standard", FleetMemberType.SHIP, false);
		
		api.addToFleet(FleetSide.PLAYER, "xlu_pumpmaster_Assault", FleetMemberType.SHIP, false);
		
		api.addToFleet(FleetSide.PLAYER, "xlu_onslaught_Standard", FleetMemberType.SHIP, true);
		api.addToFleet(FleetSide.PLAYER, "xlu_tritanite_Breaker", FleetMemberType.SHIP, false);
		
		api.addToFleet(FleetSide.PLAYER, "xlu_kite_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "xlu_butane_litho_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "xlu_colossus_litho_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "xlu_kaolinite_litho_Assault", FleetMemberType.SHIP, false);
		
		api.addToFleet(FleetSide.PLAYER, "xlu_station_level1_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "xlu_station_level2_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "xlu_station_level3_Standard", FleetMemberType.SHIP, false);
