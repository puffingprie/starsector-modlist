...
public class bt_temporaryHPPlugin implements AdvanceableListener, DamageTakenModifier {
    ...
    public void advance(float amount) {
        ...
        if (target == Global.getCombatEngine().getPlayerShip()) {
            Global.getCombatEngine().maintainStatusForPlayerShip("bt_temporaryHPPluginTimer", null, "Skinshield Active", Math.round(duration * 10f) / 10f + " " + Math.round(hullAmount), false);
        }
