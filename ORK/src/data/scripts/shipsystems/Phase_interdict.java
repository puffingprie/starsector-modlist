...
public class Phase_interdict extends BaseShipSystemScript {
	//public static final float ENERGY_DAM_PENALTY_MULT = 0.5f;
	public static final float ENERGY_DAM_PENALTY_MULT = 1f;
	
	public static final float DISRUPTION_DUR = 15f;
	public static final float MIN_DISRUPTION_RANGE = 1650f;
	
	public static final Color OVERLOAD_COLOR = new Color(229, 21, 21,135);
	
	public static final Color JITTER_COLOR = new Color(255,80,30,135);
	public static final Color JITTER_UNDER_COLOR = new Color(255,80,30,135);
