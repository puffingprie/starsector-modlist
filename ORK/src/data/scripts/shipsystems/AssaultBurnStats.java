...
public class AssaultBurnStats extends BaseShipSystemScript {
    
        public boolean isActive = false;
	public static final float ROF_BONUS = 300f;
	public static final float FLUX_REDUCTION = 50f;
        public static final float HARD_FLUX_DISSIPATION_PERCENT = 0f;
        public static final float FLUX_DISSIPATION_PERCENT = 0f;
