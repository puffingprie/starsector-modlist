...
public class bigplasma_onhit implements OnHitEffectPlugin {

    private static final Color PARTICLE_COLOR = new Color(255,80,30,135);
    private static final Color BLAST_COLOR = new Color(255,80,30,135);
    private static final Color CORE_COLOR = new Color(30, 218, 255, 150);
    private static final Color FLASH_COLOR = new Color(255,80,30,135);
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
        ...
        Global.getSoundPlayer().playSound("plasma_impact",1f,1f,point,ZERO);
    }
}
