...
public class plasma_onhit implements OnHitEffectPlugin {
    private static final float DURATION = 20f;
    private static final float RADIUS = 30f;
    private static final float CORE_RADIUS = 15f;
    private static final float MAX_DAMAGE = 50f;
    ...
    private static final Color PARTICLE_COLOUR = new Color(255,80,30,135);
    private static final Color EXPLOSION_COLOUR = new Color(255,80,30,135);
