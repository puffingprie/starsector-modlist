...
// I yoinked this from that visual and sound enhancement mod
...
public class bt_gigashotgun_everyframe implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        ...
        ON_SHOT_PARTICLE_COUNT.put("FLASH_FRINGE_1", 2);
        ON_SHOT_PARTICLE_COUNT.put("FLASH_CORE_1", 2);
        ON_SHOT_PARTICLE_COUNT.put("SMOKE_5", 40);
    }
    ...
    static {
        ...
        PARTICLE_COLOR.put("FLASH_FRINGE_1", new Color(255, 113, 18));
    ...
    static {
        PARTICLE_SIZE_MIN.put("default", 35f);
        PARTICLE_SIZE_MIN.put("FLASH_FRINGE_1", 185f);
        PARTICLE_SIZE_MIN.put("FLASH_CORE_1", 80f);
    }

    //What's the largest size the particles can have?
    private static final Map<String, Float> PARTICLE_SIZE_MAX = new HashMap<>();
    static {
        PARTICLE_SIZE_MAX.put("default", 65f);
        PARTICLE_SIZE_MAX.put("FLASH_FRINGE_1", 185f);
        PARTICLE_SIZE_MAX.put("FLASH_CORE_1", 80f);
    }
    ...
    static {
        ...
        PARTICLE_VELOCITY_MAX.put("SMOKE_5", 60f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("FLASH_FRINGE_1", 0.6f);
        PARTICLE_DURATION_MIN.put("FLASH_CORE_1", 0.6f);
    }
    ...
    static {
        PARTICLE_DURATION_MAX.put("default", 1.25f);
        PARTICLE_DURATION_MAX.put("FLASH_FRINGE_1", 0.5f);
        PARTICLE_DURATION_MAX.put("FLASH_CORE_1", 0.5f);
    }
    ...
    static {
        ...
        PARTICLE_OFFSET_MAX.put("SMOKE_3", 40f);
    ...
    //Instantiator
    public bt_gigashotgun_everyframe() {}
