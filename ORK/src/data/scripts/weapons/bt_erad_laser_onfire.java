...
public class bt_erad_laser_onfire implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    */
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_LEFT_UPPER", new Vector2f(8f, -58f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_LEFT_LOWER", new Vector2f(50f, -32f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_RIGHT_UPPER", new Vector2f(-8f, -58f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_RIGHT_LOWER", new Vector2f(-50f, -32f));
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("BLOWBACK_LEFT_UPPER", 0.25f);
        PARTICLE_DURATION_MIN.put("BLOWBACK_LEFT_LOWER", 0.25f);
        PARTICLE_DURATION_MIN.put("BLOWBACK_RIGHT_UPPER", 0.25f);
        PARTICLE_DURATION_MIN.put("BLOWBACK_RIGHT_LOWER", 0.25f);
    ...
    static {
        ...
        PARTICLE_DURATION_MAX.put("BLOWBACK_LEFT_UPPER", 0.75f);
        PARTICLE_DURATION_MAX.put("BLOWBACK_LEFT_LOWER", 0.75f);
        PARTICLE_DURATION_MAX.put("BLOWBACK_RIGHT_UPPER", 0.75f);
        PARTICLE_DURATION_MAX.put("BLOWBACK_RIGHT_LOWER", 0.75f);
    }
...
/*                MagicTrailPlugin.addTrailMemberSimple(
    ...
    public void onFire(final DamagingProjectileAPI projectile, WeaponAPI weapon, final CombatEngineAPI engine) {
        ...
        MagicRender.battlespace(
                ...
                ZERO,
                new Vector2f(70f, 170),
                new Vector2f(70, 170),
                weaponFacing,
                0f,
                new Color(102, 255, 85, 255),
                true,
                0.0f,
                0f,
                0.5f
