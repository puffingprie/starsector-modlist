...
public class bt_DTorp_OnHit implements OnHitEffectPlugin {
    ...
    static void explosion(Vector2f point, CombatEngineAPI engine, DamagingProjectileAPI projectile) {
        ...
        Global.getSoundPlayer().playSound("emp_torpedo_impact", 1f + MathUtils.getRandomNumberInRange(-0.1f, 0.1f), 1f, point, ZERO);
