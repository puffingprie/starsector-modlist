...
public class bt_siege_laser_onfire implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    */
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_LEFT_LOWER", new Vector2f(18f, -32f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_RIGHT_UPPER", new Vector2f(-0f, -56f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_RIGHT_LOWER", new Vector2f(-18f, -32f));
