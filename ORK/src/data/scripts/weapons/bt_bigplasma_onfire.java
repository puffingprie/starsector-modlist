...
public class bt_bigplasma_onfire implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    final float MUZZLE_OFFSET_HARDPOINT_SHOCKWAVE_SPRITE1 = 30f;
    final float MUZZLE_OFFSET_TURRET_SHOCKWAVE_SPRITE1 = 30f;
    final float MUZZLE_OFFSET_HARDPOINT_SHOCKWAVE_SPRITE2 = 60f;
    final float MUZZLE_OFFSET_TURRET_SHOCKWAVE_SPRITE2 = 60f;
    final float MUZZLE_OFFSET_HARDPOINT_SHOCKWAVE_SPRITE3 = 60f;
    final float MUZZLE_OFFSET_TURRET_SHOCKWAVE_SPRITE3 = 60f;
    ...
    */
    ...
    static {
        ...
        ON_SHOT_PARTICLE_COUNT.put("MUZZLE_PARTICLE_BURST", 30);
        ON_SHOT_PARTICLE_COUNT.put("ELECTROPARTICLES_BURST_LEFT", 0);
        ON_SHOT_PARTICLE_COUNT.put("ELECTROPARTICLES_BURST_RIGHT", 0);
        ON_SHOT_PARTICLE_COUNT.put("SMOKE_BURST_LEFT", 0);
        ON_SHOT_PARTICLE_COUNT.put("SMOKE_BURST_RIGHT", 0);
        ON_SHOT_PARTICLE_COUNT.put("BLOWBACK_LEFT_UPPER", 0);
        ON_SHOT_PARTICLE_COUNT.put("BLOWBACK_LEFT_LOWER", 0);
        ON_SHOT_PARTICLE_COUNT.put("BLOWBACK_RIGHT_UPPER", 0);
    ...
    static {
        ...
        PARTICLES_PER_SECOND.put("BLOWBACK_LEFT_UPPER", 0f);
        PARTICLES_PER_SECOND.put("BLOWBACK_LEFT_LOWER", 0f);
        PARTICLES_PER_SECOND.put("BLOWBACK_RIGHT_UPPER", 0f);
        PARTICLES_PER_SECOND.put("BLOWBACK_RIGHT_LOWER", 20f);
    }
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_LEFT_UPPER", new Vector2f(0f, -56f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_LEFT_LOWER", new Vector2f(0f, -32f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_RIGHT_UPPER", new Vector2f(-0f, -10f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_RIGHT_LOWER", new Vector2f(-0f, -10f));
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("MUZZLE_PARTICLE_BURST", 5f);
        PARTICLE_SIZE_MIN.put("ELECTROPARTICLES_BURST_LEFT", 3f);
        PARTICLE_SIZE_MIN.put("ELECTROPARTICLES_BURST_RIGHT", 3f);
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("MUZZLE_PARTICLE_BURST", 10f);
        PARTICLE_SIZE_MAX.put("ELECTROPARTICLES_BURST_LEFT", 6f);
        PARTICLE_SIZE_MAX.put("ELECTROPARTICLES_BURST_RIGHT", 6f);
    ...
    static {
        ...
        PARTICLE_VELOCITY_MIN.put("MUZZLE_PARTICLE_BURST", 60f);
        PARTICLE_VELOCITY_MIN.put("ELECTROPARTICLES_BURST_LEFT", 30f);
        PARTICLE_VELOCITY_MIN.put("ELECTROPARTICLES_BURST_RIGHT", 30f);
        PARTICLE_VELOCITY_MIN.put("SMOKE_BURST_LEFT", 10f);
        PARTICLE_VELOCITY_MIN.put("SMOKE_BURST_RIGHT", 10f);
        PARTICLE_VELOCITY_MIN.put("BLOWBACK_LEFT_UPPER", 70f);
        PARTICLE_VELOCITY_MIN.put("BLOWBACK_LEFT_LOWER", 70f);
        PARTICLE_VELOCITY_MIN.put("BLOWBACK_RIGHT_UPPER", 70f);
        PARTICLE_VELOCITY_MIN.put("BLOWBACK_RIGHT_LOWER", 70f);
    }
    ...
    static {
        ...
        PARTICLE_VELOCITY_MAX.put("MUZZLE_PARTICLE_BURST", 150f);
        PARTICLE_VELOCITY_MAX.put("SMOKE_BURST_LEFT", 20f);
        PARTICLE_VELOCITY_MAX.put("SMOKE_BURST_RIGHT", 20f);
        PARTICLE_VELOCITY_MAX.put("BLOWBACK_LEFT_UPPER", 120f);
        PARTICLE_VELOCITY_MAX.put("BLOWBACK_LEFT_LOWER", 120f);
        PARTICLE_VELOCITY_MAX.put("BLOWBACK_RIGHT_UPPER", 120f);
        PARTICLE_VELOCITY_MAX.put("BLOWBACK_RIGHT_LOWER", 120f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("MUZZLE_PARTICLE_BURST", 0.25f);
    ...
    static {
        ...
        PARTICLE_DURATION_MAX.put("MUZZLE_PARTICLE_BURST", 0.35f);
    ...
    static {
        ...
        PARTICLE_ARC.put("SMOKE_BURST_LEFT", 80f);
        PARTICLE_ARC.put("SMOKE_BURST_RIGHT", 80f);
        PARTICLE_ARC.put("BLOWBACK_LEFT_UPPER", 5f);
        PARTICLE_ARC.put("BLOWBACK_LEFT_LOWER", 5f);
        PARTICLE_ARC.put("BLOWBACK_RIGHT_UPPER", 5f);
        PARTICLE_ARC.put("BLOWBACK_RIGHT_LOWER", 5f);
    ...
    static {
        ...
        PARTICLE_ARC_FACING.put("BLOWBACK_LEFT_UPPER", 180f);
        PARTICLE_ARC_FACING.put("BLOWBACK_LEFT_LOWER", 180f);
        PARTICLE_ARC_FACING.put("BLOWBACK_RIGHT_UPPER", -180f);
        PARTICLE_ARC_FACING.put("BLOWBACK_RIGHT_LOWER", -180f);
    }
...
/*                MagicTrailPlugin.addTrailMemberSimple(
    ...
    public void onFire(final DamagingProjectileAPI projectile, WeaponAPI weapon, final CombatEngineAPI engine) {
        Vector2f weaponLocation = weapon.getLocation();
        float weaponFacing = weapon.getCurrAngle();
        Vector2f additionalOffset = VectorUtils.rotate(new Vector2f(0, 20), weaponFacing - 90);
