...
public class DegradedTargetingCore extends BaseHullMod {

//	public static final float BONUS = 65f;
//	
...
//	}
	...
	public static float RANGE_BONUS = 65f;
	...
	public String getDescriptionParam(int index, HullSize hullSize) {
		...
		//if (index == 1) return "" + (int)((RANGE_MULT - 1f) * 65f);
