...
public class BT_LinkedHull extends BaseHullMod {
...
//        }
    ...
    private static void advanceParent(ShipAPI parent, List<ShipAPI> children) {
        ...
        if (ec != null) {
            ...
            parent.getMutableStats().getAcceleration().modifyMult("BT_LinkedHull", enginePerformance);
            parent.getMutableStats().getDeceleration().modifyMult("BT_LinkedHull", enginePerformance);
            parent.getMutableStats().getTurnAcceleration().modifyMult("BT_LinkedHull", enginePerformance);
            parent.getMutableStats().getMaxTurnRate().modifyMult("BT_LinkedHull", enginePerformance);
            parent.getMutableStats().getMaxSpeed().modifyMult("BT_LinkedHull", enginePerformance);
            parent.getMutableStats().getZeroFluxSpeedBoost().modifyMult("BT_LinkedHull", enginePerformance);
        }
    }
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        switch (ship.getHullSpec().getBaseHullId()) {
            case "sgr_center_left":
            case "sgr_center_right":
            case "sgr_front_left":
            case "sgr_front_right":
            case "sgr_engine_left":
            case "sgr_engine_right":
