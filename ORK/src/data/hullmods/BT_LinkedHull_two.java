...
public class BT_LinkedHull_two extends BaseHullMod {
...
//        }
    ...
    private static void advanceParent(ShipAPI parent, List<ShipAPI> children) {
        ...
        if (ec != null) {
            ...
            parent.getMutableStats().getAcceleration().modifyMult("BT_LinkedHull_two", enginePerformance);
            parent.getMutableStats().getDeceleration().modifyMult("BT_LinkedHull_two", enginePerformance);
            parent.getMutableStats().getTurnAcceleration().modifyMult("BT_LinkedHull_two", enginePerformance);
            parent.getMutableStats().getMaxTurnRate().modifyMult("BT_LinkedHull_two", enginePerformance);
            parent.getMutableStats().getMaxSpeed().modifyMult("BT_LinkedHull_two", enginePerformance);
            parent.getMutableStats().getZeroFluxSpeedBoost().modifyMult("BT_LinkedHull_two", enginePerformance);
        }
    }
