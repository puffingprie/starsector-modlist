...
public class BT_LinkedHull_three extends BaseHullMod {
...
//        }
    ...
    private static void advanceParent(ShipAPI parent, List<ShipAPI> children) {
        ...
        if (ec != null) {
            ...
            parent.getMutableStats().getAcceleration().modifyMult("BT_LinkedHull_three", enginePerformance);
            parent.getMutableStats().getDeceleration().modifyMult("BT_LinkedHull_three", enginePerformance);
            parent.getMutableStats().getTurnAcceleration().modifyMult("BT_LinkedHull_three", enginePerformance);
            parent.getMutableStats().getMaxTurnRate().modifyMult("BT_LinkedHull_three", enginePerformance);
            parent.getMutableStats().getMaxSpeed().modifyMult("BT_LinkedHull_three", enginePerformance);
            parent.getMutableStats().getZeroFluxSpeedBoost().modifyMult("BT_LinkedHull_three", enginePerformance);
        }
    }
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        switch (ship.getHullSpec().getBaseHullId()) {
            case "ork_judgement_engine":
            case "ork_judgement_middle_left":
            case "ork_judgement_middle_right":
            case "ork_judgement_front_left":
            case "ork_judgement_front_right":
