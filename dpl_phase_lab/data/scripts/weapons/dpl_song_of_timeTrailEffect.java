...
public class dpl_song_of_timeTrailEffect extends BaseEveryFrameCombatPlugin {
	...
	public dpl_song_of_timeTrailEffect(MissileAPI missile, String loopId) {
	...
	public void addParticles() {
		...
		Color c = RiftLanceEffect.getColorForDarkening(new Color(150,60,255,255));
		Color undercolor = new Color(60, 0, 100, 100);
