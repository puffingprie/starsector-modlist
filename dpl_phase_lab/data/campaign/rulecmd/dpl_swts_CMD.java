...
/**
 * 
 *	dpl_swts_CMD <action> <parameters>
 */
public class dpl_swts_CMD extends BaseCommandPlugin {
	...
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, Map<String, MemoryAPI> memoryMap) {
		...
		if ("leagueLearnChoir".equals(action)) {
			FactionAPI faction = Global.getSector().getFaction("persean");
			String id = "dpl_choir_wing";
			faction.clearShipRoleCache();
			if (!faction.knowsFighter(id)) {faction.addKnownFighter(id, true);};
		}
		return false;
	}
