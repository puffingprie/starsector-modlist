 ...
 */
public class dpl_ptrs_CMD extends BaseCommandPlugin {
	...
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, Map<String, MemoryAPI> memoryMap) {
		...
		if ("makePeaceTT".equals(action)) {
			FactionAPI faction1 = Global.getSector().getFaction("tritachyon");
			FactionAPI faction2 = Global.getSector().getFaction("dpl_phase_lab");
			faction2.setRelationship(faction1.getId(), 0f);
		}
		return false;
	}
