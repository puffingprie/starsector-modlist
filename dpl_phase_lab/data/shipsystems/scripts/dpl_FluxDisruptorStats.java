...
public class dpl_FluxDisruptorStats extends com.fs.starfarer.api.impl.combat.BaseShipSystemScript {
	...
	public static final Color OVERLOAD_COLOR = new Color(5,215,200,255);
	
	public static final Color JITTER_COLOR = new Color(5,215,200,75);
	public static final Color JITTER_UNDER_COLOR = new Color(5,215,200,155);
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		String targetKey = ship.getId() + "_fluxdis_target";
	...
	public static float getMaxRange(ShipAPI ship) {
		...
		float range = MIN_DISRUPTION_RANGE;
	...
	protected void applyEffectToTarget(final ShipAPI ship, final ShipAPI target) {
		...
		if (target.getFluxTracker().showFloaty() || 
			...
			target.getFluxTracker().showOverloadFloatyIfNeeded("Phase Burst Overload!", OVERLOAD_COLOR, 4f, true);
		}
