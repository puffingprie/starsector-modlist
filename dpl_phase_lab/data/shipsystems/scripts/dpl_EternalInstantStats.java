...
public class dpl_EternalInstantStats extends BaseShipSystemScript {
	public static final float MAX_TIME_MULT = 11f;
	public static final float MIN_TIME_MULT = 0.1f;
	public static final float DAM_MULT = 0.1f;
	
	public static final Color JITTER_COLOR = new Color(165,50,255,55);
	public static final Color JITTER_UNDER_COLOR = new Color(165,50,255,155);
