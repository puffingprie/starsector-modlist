...
public class MissionDefinition implements MissionDefinitionPlugin {
    ...
    public void defineMission(MissionDefinitionAPI api) {
        ...
        api.addToFleet(FleetSide.PLAYER, "FM_Rotation_Standard", FleetMemberType.SHIP, true);

        FleetMemberAPI fleetMember;
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Firefly_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Egret_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Aya_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Witch_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Konpaku_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Puppeteer_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Rabbit_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Yagokoro_Standard", FleetMemberType.SHIP, false);
        //fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Yagokoro_Standard", FleetMemberType.SHIP,false);
        //fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Yagokoro_Standard", FleetMemberType.SHIP,false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Satori_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Miko_Standard", FleetMemberType.SHIP, false);
        //fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Miko_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Parasol_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Miracle_Standard", FleetMemberType.SHIP, false);
        //fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Miracle_Standard", FleetMemberType.SHIP,false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Byakuren_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Nightbird_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Loupgarou_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Hearn_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Rumia_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Reisen_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Baize_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Bazhiwu_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "buffalo_FM_Standard", FleetMemberType.SHIP, false);
        fleetMember = api.addToFleet(FleetSide.PLAYER, "FM_Bibliophilia_Standard", FleetMemberType.SHIP, false);
...
//		api.addToFleet(FleetSide.ENEMY, "mining_drone_wing", FleetMemberType.FIGHTER_WING, false).getCaptain().setPersonality("suicidal");
        ...
        api.addPlanet(-256, -512, 640f, "star_yellow", 1f, false);
    }
