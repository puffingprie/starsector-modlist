...
public class FM_dumplingstrike extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
    ...
    public static final Color JITTER_COLOR = new Color(255, 238, 0, 101);
    public static final Color JITTER_UNDER_COLOR = new Color(255, 224, 42, 92);
