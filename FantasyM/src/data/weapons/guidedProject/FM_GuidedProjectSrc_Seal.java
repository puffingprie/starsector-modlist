...
public class FM_GuidedProjectSrc_Seal extends BaseEveryFrameCombatPlugin {
    ...
    private static final float TARGET_REACQUIRE_RANGE = 800f;
    ...
    private static final float TURN_RATE = 45f;
    ...
    private static final float SWAY_AMOUNT_PRIMARY = 10f;
    ...
    //Secondary and primary sway both run in parallel, allowing double-sine swaying if desired
    private static final float SWAY_PERIOD_PRIMARY = 0.2f;
    ...
    private static final float ONE_TURN_TARGET_INACCURACY = 3f;
    ...
    private static final float GUIDANCE_DELAY_MAX = 0.8f;
    private static final float GUIDANCE_DELAY_MIN = 0.8f;
     ...
     */
    public FM_GuidedProjectSrc_Seal(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
