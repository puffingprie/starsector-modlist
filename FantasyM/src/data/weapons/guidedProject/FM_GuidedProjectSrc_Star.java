...
public class FM_GuidedProjectSrc_Star extends BaseEveryFrameCombatPlugin {
    ...
    private static final float SWAY_FALLOFF_FACTOR = 2f;
    ...
    private static final float GUIDANCE_DELAY_MAX = 0.25f;
    private static final float GUIDANCE_DELAY_MIN = 0.25f;
     ...
     */
    public FM_GuidedProjectSrc_Star(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
