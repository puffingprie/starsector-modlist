...
public class FM_GuidedProjectSrc_Desire extends BaseEveryFrameCombatPlugin {
    ...
    private static final String GUIDANCE_MODE_PRIMARY = "ONE_TURN_TARGET";
    ...
    private static final float TARGET_REACQUIRE_RANGE = 3000f;
    ...
    private static final float GUIDANCE_DELAY_MIN = 0.025f;
     ...
     */
    public FM_GuidedProjectSrc_Desire(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
