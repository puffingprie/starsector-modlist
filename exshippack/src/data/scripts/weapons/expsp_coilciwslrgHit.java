...
public class expsp_coilciwslrgHit implements OnHitEffectPlugin {

    private static final float EXTRA_DAMAGE = 60;
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
        ...
        if (target instanceof ShipAPI && ((ShipAPI) target).isFighter()) {
            engine.applyDamage(target, point, EXTRA_DAMAGE, KINETIC, 20f, false, false, projectile.getSource());
        }
