...
public class expsp_hunterflakHit implements OnHitEffectPlugin {

    private static final float EXTRA_DAMAGE = 20;
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
        ...
        if (target instanceof ShipAPI && ((ShipAPI) target).isFighter()) {
            engine.applyDamage(target, point, EXTRA_DAMAGE, ENERGY, 20f, false, false, projectile.getSource());
        }
