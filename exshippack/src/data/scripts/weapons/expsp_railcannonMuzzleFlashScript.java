...
public class expsp_railcannonMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        ON_SHOT_PARTICLE_COUNT.put("default", 6);
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(5f, 4f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_2", new Vector2f(-5f, 4f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(5f, 6f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_2", new Vector2f(-5f, 6f));
    }
    ...
    static {
        PARTICLE_VELOCITY_MIN.put("default", 3f);
    }
    ...
    static {
        PARTICLE_ARC_FACING.put("default", 45f);
        PARTICLE_ARC_FACING.put("FLASH_ID_2", -45f);
    }
    ...
    //Instantiator
    public expsp_railcannonMuzzleFlashScript() {}
