...
public class expsp_EvelynOnHitEffect implements OnHitEffectPlugin {
    ...
    private static final Color EXPLOSION_COLOR = new Color(50 / 255f, 105f / 255f, 255f / 255f, 200f / 255f);
    ...
    private static final Color PARTICLE_COLOR = new Color(50 / 255f, 105f / 255f, 255f / 255f, 200f / 255f);
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
        ...
        Float critLevel = MathUtils.getRandomNumberInRange(0.3f, 0.75f);
        if (projectile.didDamage()) {
            Global.getCombatEngine().applyDamage(target, point, critLevel * bonusDamage, DamageType.ENERGY, 40, false, false, projectile.getSource(), true);
        }
