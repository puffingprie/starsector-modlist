...
public class expsp_mvsdisruptor extends BaseShipSystemScript {
	//public static final float ENERGY_DAM_PENALTY_MULT = 0.5f;
	public static float ENERGY_DAM_PENALTY_MULT = 1f;
	
	public static float DISRUPTION_DUR = 3f;
	protected static float MIN_DISRUPTION_RANGE = 1000f;
	
	public static final Color OVERLOAD_COLOR = new Color(98, 255, 0,255);
	
	public static final Color JITTER_COLOR = new Color(78, 255, 0,75);
	public static final Color JITTER_UNDER_COLOR = new Color(57, 255, 0,155);
