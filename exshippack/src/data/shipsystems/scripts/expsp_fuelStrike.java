...
public class expsp_fuelStrike extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
	
	protected static float MINE_RANGE = 1500f;
	
	public static final float MIN_SPAWN_DIST = 55f;
	public static final float MIN_SPAWN_DIST_FRIGATE = 75f;
	
	public static final float LIVE_TIME = 5f;
	
	public static final Color JITTER_COLOR = new Color(155,100,255,75);
	public static final Color JITTER_UNDER_COLOR = new Color(155,100,255,155);
