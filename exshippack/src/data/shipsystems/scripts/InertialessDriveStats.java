...
public class InertialessDriveStats extends BaseShipSystemScript {
	...
	public static final Color JITTER_COLOR = new Color(50,205,255,55);
	public static final Color JITTER_UNDER_COLOR = new Color(50,205,255,155);
...
*/
	...
	public StatusData getStatusData(int index, State state, float effectLevel) {
		float shipTimeMult = 1f + (MAX_TIME_MULT - 1f) * effectLevel;
		if (index == 0) {
			return new StatusData("Maneuverability drastically increased", false);
		}
//		if (index == ) {
