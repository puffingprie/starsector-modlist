...
public class MVSDisruptorStats extends BaseShipSystemScript {
	//public static final float ENERGY_DAM_PENALTY_MULT = 0.5f;
	public static float ENERGY_DAM_PENALTY_MULT = 0.01f;
	
	public static float DISRUPTION_DUR = 3f;
	protected static float MIN_DISRUPTION_RANGE = 1000f;
	public static final Color OVERLOAD_COLOR = new Color(55,255,55,255);
