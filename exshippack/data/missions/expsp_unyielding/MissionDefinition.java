package data.missions.expsp_unyielding;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "MVS Scion of Blood and elements of the 5th Task Force");
		...
		api.addToFleet(FleetSide.PLAYER, "expsp_cainhurst_Lancer", FleetMemberType.SHIP, "Scion of Blood", true);

		api.addToFleet(FleetSide.PLAYER, "expsp_anker_Lancer", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "expsp_principality_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "expsp_virtue_Standard", FleetMemberType.SHIP, false);
		
		api.addToFleet(FleetSide.PLAYER, "expsp_hetzer_Standard", FleetMemberType.SHIP, false);
		
		api.addToFleet(FleetSide.PLAYER, "expsp_kriegsmesser_Strike", FleetMemberType.SHIP, false);

		api.addToFleet(FleetSide.PLAYER, "expsp_stiletto_Closequarters", FleetMemberType.SHIP, false);

		api.addToFleet(FleetSide.PLAYER, "expsp_kriegsmesser_Standard", FleetMemberType.SHIP, false);
		...
		fleetMember = api.addToFleet(FleetSide.ENEMY, "expsp_favela_Standard", FleetMemberType.SHIP, "Plunder and Burn", false);
		...
		api.addToFleet(FleetSide.ENEMY, "venture_Exploration", FleetMemberType.SHIP, false);
		...
		api.addToFleet(FleetSide.ENEMY, "venture_Balanced", FleetMemberType.SHIP, "Ravager", false);
