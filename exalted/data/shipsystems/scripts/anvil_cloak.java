...
public class anvil_cloak extends BaseShipSystemScript {

	public static final Color JITTER_COLOR = new Color(0,255,81,255);
	public static final float JITTER_FADE_TIME = 0.7f;
	...
	public static final float MAX_TIME_MULT = 3.5f;
