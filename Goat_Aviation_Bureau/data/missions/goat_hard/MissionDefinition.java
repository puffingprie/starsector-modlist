package data.missions.goat_hard;
...
//		api.getDefaultCommander(FleetSide.PLAYER).getStats().setSkillLevel(Skills.ELECTRONIC_WARFARE, 3);
		...
		api.setFleetTagline(FleetSide.PLAYER, "Your recently purchased Sunlance model");
		api.setFleetTagline(FleetSide.ENEMY, "A dumb simulated ship");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Sunlance must survive.");
		api.addBriefingItem("Use your maneuverability to bully your opponent.");
...
//			member.getCaptain().getStats().setSkillLevel(Skills.HELMSMANSHIP, 2);
	...
	//		member.setCaptain(person);
		...
		api.addPlanet(0, 0, 50f, StarTypes.YELLOW, 350f, true);
