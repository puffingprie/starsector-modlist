...
public class goat_DashOnFireEffect implements OnFireEffectPlugin {

	@Override
	public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {

		addHitParticles(engine, 45f, 8f, 5f, 30f, 0.25f, 26, new Color(255, 120, 50, 205), projectile.getLocation(), projectile.getWeapon().getShip().getVelocity(), projectile.getFacing() - 0f);
		addHitParticles(engine, 5f, 90f, 35f, 50f, 0.05f, 16, new Color(255, 165, 79, 205), projectile.getLocation(), projectile.getWeapon().getShip().getVelocity(), projectile.getFacing() - 0f);
