...
public class goat_AcausalDisruptorStats  extends BaseShipSystemScript {

    public static float ENERGY_DAM_PENALTY_MULT = 2f;

    public static float DISRUPTION_DUR = 2f;
    protected static float MIN_DISRUPTION_RANGE = 800f;

    public static final Color OVERLOAD_COLOR = new Color(71, 52, 246,255);

    public static final Color JITTER_COLOR = new Color(155, 255, 255,75);
    public static final Color JITTER_UNDER_COLOR = new Color(233, 155,255,155);
    ...
    public void apply(MutableShipStatsAPI stats, String id, ShipSystemStatsScript.State state, float effectLevel) {
        ...
        ship.setJitter(this, JITTER_COLOR, jitterLevel, 3, 0f, 0 + jitterRangeBonus);
    ...
    protected void applyEffectToTarget(final ShipAPI ship, final ShipAPI target) {
        ...
        if (target.getFluxTracker().showFloaty() ||
            ...
            target.getFluxTracker().showOverloadFloatyIfNeeded("Overloaded!", OVERLOAD_COLOR, 4f, true);
        }
    ...
    public ShipSystemStatsScript.StatusData getStatusData(int index, ShipSystemStatsScript.State state, float effectLevel) {
        ...
        if (index == 0 && percent > 0) {
            return new ShipSystemStatsScript.StatusData((int)percent + "% energy damage taken", false);
        }
        return null;
    }
