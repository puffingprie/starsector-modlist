package data.missions.goat_test;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		for (String id : Global.getSettings().getAllVariantIds()) {
			...
			if (variant.getHullSpec().getHullId().startsWith("goat_") && variant.getHullSpec().getHullSize() != ShipAPI.HullSize.FIGHTER && !variant.getHullSpec().getHullId().contains("module") && !id.startsWith("mission_")) {
				variants.add(id);
			}
		}
