...
public class sv_energyspecialization extends BaseHullMod {
    ...
    public void applyEffectsBeforeShipCreation(ShipAPI.HullSize hullSize, MutableShipStatsAPI stats, String id) {
        stats.getEnergyWeaponDamageMult().modifyPercent(id, (Float) mag.get(hullSize));
        stats.getEnergyWeaponFluxCostMod().modifyPercent(id, -(Float) mag.get(hullSize));
        stats.getEnergyWeaponRangeBonus().modifyPercent(id, (Float) mag.get(hullSize));
        stats.getEnergyProjectileSpeedMult().modifyPercent(id, (Float) mag.get(hullSize));
        stats.getEnergyRoFMult().modifyPercent(id, (Float) mag.get(hullSize));
        stats.getEnergyAmmoBonus().modifyPercent(id, (Float) mag.get(hullSize));
        stats.getEnergyAmmoRegenMult().modifyPercent(id, (Float) mag.get(hullSize));
