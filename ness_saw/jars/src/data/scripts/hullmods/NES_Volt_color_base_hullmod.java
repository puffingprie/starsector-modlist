...
public abstract class NES_Volt_color_base_hullmod extends BaseHullMod {

    public static final String DEFAULT = "NES_Default";
    public static final String CRIMSON = "NES_Crimson";
    public static final String HAZARD = "NES_Hazard";
