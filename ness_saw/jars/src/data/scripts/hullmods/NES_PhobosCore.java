...
//		stats.getRecoilPerShotMult().modifyMult(id, 0f);
		...
		//stats.getBeamWeaponTurnRateBonus().modifyMult(id, 2f); //phobos drone got no beams, removed this
		//stats.getBeamWeaponRangeBonus().modifyFlat(id, 300f); //phobos drone got no beams, removed this
