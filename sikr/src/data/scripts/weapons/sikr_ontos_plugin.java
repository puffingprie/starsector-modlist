...
public class sikr_ontos_plugin implements EveryFrameWeaponEffectPlugin{
    ...
    /*
      ...
      */
      ...
      static {
          ...
          USED_IDS.add("R_SMOKE_1");
          USED_IDS.add("R_FLASH_CORE_1");
          USED_IDS.add("R_FLASH_FRINGE_1");
      }
      ...
      static {
          ...
          ON_SHOT_PARTICLE_COUNT.put("SMOKE_1", 15);
          ON_SHOT_PARTICLE_COUNT.put("FLASH_CORE_1", 1);
          ON_SHOT_PARTICLE_COUNT.put("FLASH_FRINGE_1", 15);
          ON_SHOT_PARTICLE_COUNT.put("R_SMOKE_1", 15);
          ON_SHOT_PARTICLE_COUNT.put("R_FLASH_CORE_1", 1);
          ON_SHOT_PARTICLE_COUNT.put("R_FLASH_FRINGE_1", 15);
      ...
      private final Map<String, Vector2f> PARTICLE_SPAWN_POINT_TURRET = new HashMap<>();
        {
      ...
      private final Map<String, Vector2f> PARTICLE_SPAWN_POINT_HARDPOINT = new HashMap<>();
        {
      ...
      static {
          ...
          PARTICLE_TYPE.put("SMOKE_1", "SMOKE");
          PARTICLE_TYPE.put("FLASH_CORE_1", "BRIGHT");
          PARTICLE_TYPE.put("FLASH_FRINGE_1", "SMOOTH");
          PARTICLE_TYPE.put("R_SMOKE_1", "SMOKE");
          PARTICLE_TYPE.put("R_FLASH_CORE_1", "BRIGHT");
          PARTICLE_TYPE.put("R_FLASH_FRINGE_1", "SMOOTH");
      ...
      static {
          ...
          PARTICLE_COLOR.put("SMOKE_1", new Color(150,140,140, 135));
          PARTICLE_COLOR.put("FLASH_CORE_1", new Color(255,240,165,200));
          PARTICLE_COLOR.put("FLASH_FRINGE_1", new Color(255,240,165,200));
          PARTICLE_COLOR.put("R_SMOKE_1", new Color(150,140,140, 135));
          PARTICLE_COLOR.put("R_FLASH_CORE_1", new Color(255,240,165,200));
          PARTICLE_COLOR.put("R_FLASH_FRINGE_1", new Color(255,240,165,200));
      ...
      static {
          ...
          PARTICLE_SIZE_MIN.put("FLASH_CORE_1", 25f);
          PARTICLE_SIZE_MIN.put("FLASH_FRINGE_1", 15f);
          PARTICLE_SIZE_MIN.put("R_FLASH_CORE_1", 25f);
          PARTICLE_SIZE_MIN.put("R_FLASH_FRINGE_1", 15f);
      }
      ...
      static {
          ...
          PARTICLE_SIZE_MAX.put("FLASH_CORE_1", 25f);
          PARTICLE_SIZE_MAX.put("FLASH_FRINGE_1", 20f);
          PARTICLE_SIZE_MAX.put("R_FLASH_CORE_1", 25f);
          PARTICLE_SIZE_MAX.put("R_FLASH_FRINGE_1", 20f);
      }
      ...
      static {
          ...
          PARTICLE_VELOCITY_MAX.put("FLASH_CORE_1", 20f);
          PARTICLE_VELOCITY_MAX.put("R_FLASH_CORE_1", 20f);
      }
      ...
      static {
          ...
          PARTICLE_DURATION_MIN.put("FLASH_CORE_1", 0.2f);
          PARTICLE_DURATION_MIN.put("FLASH_FRINGE_1", 0.5f);
          PARTICLE_DURATION_MIN.put("R_FLASH_CORE_1", 0.2f);
          PARTICLE_DURATION_MIN.put("R_FLASH_FRINGE_1", 0.5f);
      ...
      static {
          ...
          PARTICLE_DURATION_MAX.put("FLASH_CORE_1", 0.2f);
          PARTICLE_DURATION_MAX.put("FLASH_FRINGE_1", 1f);
          PARTICLE_DURATION_MAX.put("R_FLASH_CORE_1", 0.2f);
          PARTICLE_DURATION_MAX.put("R_FLASH_FRINGE_1", 1f);
      ...
      static {
          ...
          PARTICLE_OFFSET_MAX.put("SMOKE_1", 0f);
          PARTICLE_OFFSET_MAX.put("FLASH_CORE_1", 0f);
          PARTICLE_OFFSET_MAX.put("FLASH_FRINGE_1", 0f);
          PARTICLE_OFFSET_MAX.put("R_SMOKE_1", 0f);
          PARTICLE_OFFSET_MAX.put("R_FLASH_CORE_1", 0f);
          PARTICLE_OFFSET_MAX.put("R_FLASH_FRINGE_1", 0f);
      ...
      static {
          ...
          PARTICLE_ARC.put("SMOKE_1", 5f);
          PARTICLE_ARC.put("FLASH_CORE_1", 0f);
          PARTICLE_ARC.put("FLASH_FRINGE_1", 0f);
          PARTICLE_ARC.put("R_SMOKE_1", 5f);
          PARTICLE_ARC.put("R_FLASH_CORE_1", 0f);
          PARTICLE_ARC.put("R_FLASH_FRINGE_1", 0f);
      ...
      static {
          ...
          PARTICLE_ARC_FACING.put("R_SMOKE_1", 180f);
          PARTICLE_ARC_FACING.put("R_FLASH_CORE_1", 180f);
          PARTICLE_ARC_FACING.put("R_FLASH_FRINGE_1", 180f);
      ...
      public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
          ...
          if (doOnce) {
            ...
            if(weapon.getSize() == WeaponSize.MEDIUM){
                PARTICLE_SPAWN_POINT_TURRET.put("R_SMOKE_1", new Vector2f(0f, -50f));
                PARTICLE_SPAWN_POINT_TURRET.put("R_FLASH_CORE_1", new Vector2f(0f, -50f));
                PARTICLE_SPAWN_POINT_TURRET.put("R_FLASH_FRINGE_1", new Vector2f(0f, -50f));

                PARTICLE_SPAWN_POINT_HARDPOINT.put("R_SMOKE_1", new Vector2f(0f, -40f));
                PARTICLE_SPAWN_POINT_HARDPOINT.put("R_FLASH_CORE_1", new Vector2f(0f, -40f));
                PARTICLE_SPAWN_POINT_HARDPOINT.put("R_FLASH_FRINGE_1", new Vector2f(0f, -40f));
            }else{
                PARTICLE_SPAWN_POINT_TURRET.put("R_SMOKE_1", new Vector2f(0f, -65f));
                PARTICLE_SPAWN_POINT_TURRET.put("R_FLASH_CORE_1", new Vector2f(0f, -65f));
                PARTICLE_SPAWN_POINT_TURRET.put("R_FLASH_FRINGE_1", new Vector2f(0f, -65f));

                PARTICLE_SPAWN_POINT_HARDPOINT.put("R_SMOKE_1", new Vector2f(0f, -58f));
                PARTICLE_SPAWN_POINT_HARDPOINT.put("R_FLASH_CORE_1", new Vector2f(0f, -58f));
                PARTICLE_SPAWN_POINT_HARDPOINT.put("R_FLASH_FRINGE_1", new Vector2f(0f, -58f));
            }
