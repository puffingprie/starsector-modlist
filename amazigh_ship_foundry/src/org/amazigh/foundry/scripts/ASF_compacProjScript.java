...
//	run "engine.addPlugin(ASF_compacProjScript(proj, target));" with:
//		ASF_compacProjScript being replaced with your new class name
...
public class ASF_compacProjScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float TURN_RATE = 1080f;
	 ...
	 */
	public ASF_compacProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
