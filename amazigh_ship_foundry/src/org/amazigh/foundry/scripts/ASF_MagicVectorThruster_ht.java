...
public class ASF_MagicVectorThruster_ht implements EveryFrameWeaponEffectPlugin {
    ...
    private Vector2f size= new Vector2f(14,96);
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
    	...
    	Vector2f glowSize = new Vector2f(28f + (glowScalar * 14f), 28f + (glowScalar * 14f));
    	Vector2f glowLoc = MathUtils.getPointOnCircumference(weapon.getLocation(), 4f, weapon.getCurrAngle());
    	int alpha = 210;
