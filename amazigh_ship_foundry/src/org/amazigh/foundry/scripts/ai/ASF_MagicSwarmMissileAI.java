...
// Modifications to make missiles with this script "swarm" outwards, and use "MISSILE_SPREAD" behaviour
...
public class ASF_MagicSwarmMissileAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    */
    ...
    private float SWARM_OFFSET = 25f;
    ...
    public ASF_MagicSwarmMissileAI(MissileAPI missile, ShipAPI launchingShip) {
