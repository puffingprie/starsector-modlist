...
public class Arx_Mod_RagnorakCore extends BaseHullMod {
        public static float FLUX_CAPACITY_BONUS = 400f;
        public static float FLUX_DISSIPATION_BONUS = 400f;
        public static float HARD_FLUX_DISSIPATION_FRACTION_BONUS = 40f;
        public static float VENT_RATE_BONUS = 400f;
        public static float PEAK_CR_TIME_BONUS = 100f;
        public static float MAX_CR_BONUS = 60f;
        public static float SENSOR_BONUS = 100f;
        public static float SENSOR_PROFILE_BONUS = 100f;
        public static float CORONA_EFFECT_BONUS = 100f;
        public static float ZERO_FLUX_SPEED_BONUS = 200f;
        public static float SPEED_BONUS = 200f;
        public static float MANEUVERABILITY_BONUS = 100f;
        public static float ACCELERATION_BONUS = 200f;
        public static float DECELERATION_BONUS = 200f;
        public static float BURN_BONUS = 16f;
        public static float ENGINE_DURABILITY_BONUS = 400f;
        public static float ENGINE_REPAIR_TIME_BONUS = 200f;
        public static float HULL_BONUS = 400f;
        public static float ARMOR_BONUS = 400f;
        public static float SHIELD_ARC_BONUS = 480f;
        public static float SHIELD_UNFOLD_BONUS = 200f;
        public static float SHIELD_UPKEEP_BONUS = 200f;
        public static float CREW_CAPACITY_BONUS = 400f;
        public static float MIN_CREW_BONUS = 200f;
        public static float CREW_LOSS_BONUS = 200f;
        public static float CARGO_CAPACITY_BONUS = 1600f;
        public static float SUPPLY_USE_BONUS = 200f;
        public static float FUEL_CAPACITY_BONUS = 1600f;
        public static float FUEL_USE_BONUS = 200f;
        public static float WING_RANGE_BONUS = 400f;
        public static float WING_REPLACEMENT_BONUS = 100f;
        public static float WING_HULL_FLAT_BONUS = 800f;
        public static float WING_ARMOR_FLAT_BONUS = 200f;
        public static float WING_HULL_BONUS = 400f;
        public static float WING_ARMOR_BONUS = 400f;
        public static float WING_FLUX_BONUS = 2000f;
        public static float WING_SPEED_BONUS = 200f;
        public static float WING_DAMAGE_BONUS = 200f;
        public static float AMMO_BONUS = 200f;
        public static float PROJECTILE_SPEED_BONUS = 200f;
        public static float ROF_BONUS = 200f;
        public static float DAMAGE_BONUS = 400f;
        public static float FLUX_COST_BONUS = -100f;
        public static float RANGE_BONUS = 400f;
        public static float MISSILE_RANGE_BONUS = 200f;
        public static float WEAPON_TURN_RATE_BONUS = 200f;
        public static float MISSILE_HP_BONUS = 200f;
        public static float SIGHT_BONUS = 400f;
        public static float WEAPON_DURABILITY_BONUS = 400f;
        public static float WEAPON_REPAIR_TIME_BONUS = 200f;
        public static float WEAPON_OP_COST_BONUS = 200f;
        public static float HULL_REGEN_PERCENTAGE = 0.300f;
        ...
        public void advanceInCombat(ShipAPI ship, float amount) {
                ...
                float hullRegen = HULL_REGEN_PERCENTAGE;
