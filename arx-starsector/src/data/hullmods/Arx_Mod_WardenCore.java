...
public class Arx_Mod_WardenCore extends BaseHullMod {
        public static float FLUX_CAPACITY_BONUS = 50f;
        public static float FLUX_DISSIPATION_BONUS = 50f;
        public static float HARD_FLUX_DISSIPATION_FRACTION_BONUS = 5f;
        public static float VENT_RATE_BONUS = 50f;
        public static float PEAK_CR_TIME_BONUS = 12.5f;
        public static float MAX_CR_BONUS = 7.5f;
        public static float SENSOR_BONUS = 12.5f;
        public static float SENSOR_PROFILE_BONUS = 12.5f;
        public static float ZERO_FLUX_SPEED_BONUS = 25f;
        public static float SPEED_BONUS = 25f;
        public static float MANEUVERABILITY_BONUS = 12.5f;
        public static float ACCELERATION_BONUS = 25f;
        public static float DECELERATION_BONUS = 25f;
        public static float BURN_BONUS = 2f;
        public static float ENGINE_DURABILITY_BONUS = 50f;
        public static float ENGINE_REPAIR_TIME_BONUS = 25f;
        public static float HULL_BONUS = 50f;
        public static float ARMOR_BONUS = 50f;
        public static float SHIELD_ARC_BONUS = 60f;
        public static float SHIELD_UNFOLD_BONUS = 25f;
        public static float SHIELD_UPKEEP_BONUS = 25f;
        public static float CREW_CAPACITY_BONUS = 50f;
        public static float MIN_CREW_BONUS = 25f;
        public static float CREW_LOSS_BONUS = 25f;
        public static float CARGO_CAPACITY_BONUS = 200f;
        public static float SUPPLY_USE_BONUS = 25f;
        public static float FUEL_CAPACITY_BONUS = 200f;
        public static float FUEL_USE_BONUS = 25f;
        public static float WING_RANGE_BONUS = 50f;
        public static float WING_REPLACEMENT_BONUS = 12.5f;
        public static float WING_HULL_FLAT_BONUS = 100f;
        public static float WING_ARMOR_FLAT_BONUS = 25f;
        public static float WING_HULL_BONUS = 50f;
        public static float WING_ARMOR_BONUS = 50f;
        public static float WING_FLUX_BONUS = 250f;
        public static float WING_SPEED_BONUS = 25f;
        public static float WING_DAMAGE_BONUS = 25f;
        public static float AMMO_BONUS = 25f;
        public static float PROJECTILE_SPEED_BONUS = 25f;
        public static float ROF_BONUS = 25f;
        public static float DAMAGE_BONUS = 50f;
        public static float FLUX_COST_BONUS = -12.5f;
        public static float RANGE_BONUS = 50f;
        public static float MISSILE_RANGE_BONUS = 25f;
        public static float WEAPON_TURN_RATE_BONUS = 25f;
        public static float MISSILE_HP_BONUS = 25f;
        public static float SIGHT_BONUS = 50f;
        public static float WEAPON_DURABILITY_BONUS = 50f;
        public static float WEAPON_REPAIR_TIME_BONUS = 25f;
        public static float WEAPON_OP_COST_BONUS = 25f;
