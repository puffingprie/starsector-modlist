...
public class acs_watchtowerrail extends BaseEveryFrameCombatPlugin {
    ...
    private static final String acs_watchtowerShipID = "acs_watchtowerfrig_variant";
    private static final String acs_watchtowerProjectileID = "acs_watchtowerrail_lrm";
    ...
    public void advance(float amount, List<InputEventAPI> events) {
        ...
        while (iter.hasNext()) {
            ...
            switch (projectile.getProjectileSpecId()) {
                case acs_watchtowerProjectileID: {
                    ...
                    FleetMemberAPI missileMember = Global.getFactory().createFleetMember(FleetMemberType.SHIP, acs_watchtowerShipID);
