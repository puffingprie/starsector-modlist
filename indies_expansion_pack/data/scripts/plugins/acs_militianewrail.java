...
public class acs_militianewrail extends BaseEveryFrameCombatPlugin {
    ...
    private static final String acs_mookShipID = "acs_militianewrail_wing";
    private static final String acs_mookProjectileID = "acs_militianewrail_lrm";
