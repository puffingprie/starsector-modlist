...
public class acs_mookrail extends BaseEveryFrameCombatPlugin {
    ...
    private static final String acs_mookShipID = "acs_mookrail";
    private static final String acs_mookProjectileID = "acs_mookrail_lrm";
