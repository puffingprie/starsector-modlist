...
public class acs_bigmookrail extends BaseEveryFrameCombatPlugin {
    ...
    private static final String acs_bigmookShipID = "acs_bigmookfrig_variant";
    private static final String acs_bigmookProjectileID = "acs_bigmookrail_lrm";
