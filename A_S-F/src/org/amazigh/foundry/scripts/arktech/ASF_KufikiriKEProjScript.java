...
public class ASF_KufikiriKEProjScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float TURN_RATE = 56f;
	...
	private static final float SWAY_AMOUNT_PRIMARY = 2f;
	...
	//Secondary and primary sway both run in parallel, allowing double-sine swaying if desired
	private static final float SWAY_PERIOD_PRIMARY = 0.7f; //1.4
	private static final float SWAY_PERIOD_SECONDARY = 1.5f; //3
	 ...
	 */
	public ASF_KufikiriKEProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
