...
public class ssp_guardian extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
	
	@Override
	public boolean isHidden() {
		return !market.getFactionId().equals("LLI");
	}
	
	@Override
	public boolean isFunctional() {
		return super.isFunctional() && market.getFactionId().equals("LLI");
	}
	...
	public CampaignFleetAPI spawnFleet(RouteData route) {
		...
		case COMBAT:
			...
			break;
		case HEAVY:
			combat = Math.round(12f + (float) random.nextFloat() * 5f) * 5f;
...
//		fleet.addScript(ai);
	...
	public String getRouteSourceId() {
		return getMarket().getId() + "_" + "ssp_guardian";
	}
