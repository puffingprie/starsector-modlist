...
public class II_AnamorphicFlare {
    ...
    public static void createFlare(ShipAPI origin, Vector2f point, CombatEngineAPI engine, float brightness, float thickness, float angle, float spread,
        ...
        for (int i = 0; i < magnitude; i++) {
            ...
            Color fringeColorP = new Color(fringeColor.getRed(), fringeColor.getGreen(), fringeColor.getBlue(), II_Util.clamp255(alphaf));
            Color coreColorP = new Color(coreColor.getRed(), coreColor.getGreen(), coreColor.getBlue(), II_Util.clamp255(alpha));
