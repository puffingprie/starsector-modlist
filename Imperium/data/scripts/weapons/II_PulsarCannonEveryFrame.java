...
public class II_PulsarCannonEveryFrame implements EveryFrameWeaponEffectPlugin {

    private static final Color MUZZLE_FLASH_COLOR = new Color(255, 100, 25, 255);
    private static final float MUZZLE_FLASH_DURATION = 0.1f;
    private static final float MUZZLE_FLASH_SIZE = 20.0f;
    private static final Vector2f MUZZLE_OFFSET_HARDPOINT = new Vector2f(7.75f, 0f);
    private static final Vector2f MUZZLE_OFFSET_TURRET = new Vector2f(7f, 0f);
