...
public class II_TriplexBeamEffect implements BeamEffectPlugin {

    private static final Color COLOR1 = new Color(255, 160, 100);
    private static final Color COLOR2 = new Color(255, 170, 150);
    private static final Color COLOR3 = new Color(255, 160, 100, 100);
