package data.missions.swp_custombattle;
...
import data.missions.SWP_BaseRandomBattle;
import java.util.List;
import org.lazywizard.lazylib.MathUtils;
import org.lwjgl.input.Keyboard;

public class MissionDefinition extends SWP_BaseRandomBattle {
    ...
    public void defineMission(MissionDefinitionAPI api) {
        ...
        if (first || Keyboard.isKeyDown(Keyboard.KEY_LCONTROL) || Keyboard.isKeyDown(Keyboard.KEY_RCONTROL)) {
            ...
            enemyAdvantage = 100;
            playerQualityFactor = 125;
            enemyQualityFactor = 125;
            playerOPBonus = 0.0;
            enemyOPBonus = 0.0;
            playerSMods = -1;
            enemySMods = -1;
